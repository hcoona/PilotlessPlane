...
using System.Net;
using UnderlyingFrameC = ReceiveAndParse.Underlying.FrameC;

namespace ReceiveAndParse.Models
{
    public partial struct FrameC
    {
        private static readonly BitVector32.Section z纵向模态Section;
        private static readonly BitVector32.Section h横向模态Section;
        private static readonly BitVector32.Section d导航模态Section;

        static FrameC()
        {
            z纵向模态Section = BitVector32.CreateSection(7);
            h横向模态Section = BitVector32.CreateSection(7, z纵向模态Section);
            d导航模态Section = BitVector32.CreateSection(3, h横向模态Section);
        }
